<form method="post" action=CompanyAdminActionBarServlet>
      		...
      		<li class="dropdown">
        		...
        		<ul class="dropdown-menu">
        			...
        			<li><button type="submit" class="btn btn-primary btn-block" name="actionvalue" value="edituser">Edit</button></li>                  
          			...
          			<li><button type="submit" class="btn btn-primary btn-block" name="actionvalue" value="importuser">Import</button></li>
          			<li><button type="submit" class="btn btn-primary btn-block" name="actionvalue" value="importluserog">ImportLog</button></li>
        		</ul>
      		</li>
      		<li class="dropdown">
        		<a class="dropdown-toggle" data-toggle="dropdown">VendorCompany<span class="caret"></span></a>
        		<ul class="dropdown-menu">
          			<li><button type="submit" class="btn btn-primary btn-block" name="actionvalue" value="newvendorcompany">New</button></li>          
          			<li><button type="submit" class="btn btn-primary btn-block" name="actionvalue" value="viewvendorcompany">View</button></li>        
        			<li><button type="submit" class="btn btn-primary btn-block" name="actionvalue" value="editvendorcompany">Edit</button></li>                  
          			<li><button type="submit" class="btn btn-primary btn-block" name="actionvalue" value="vendorcompanylog">Log</button></li>
        		</ul>
      		</li>
     		</ul>
		</div>
