				...
				<div class="row">
  					...
  					<div class="col-sm-8">
  						<div class="panel panel-primary well well-sm">
							<div class="panel-heading" align="center">Add New VendorCompany</div>
							<div class="panel-body">
  							<form class="form-horizontal" method="post" action="VendorCompanyServlet">	  							  							
  								<div class="form-group">  
      								<label class="control-label col-sm-4" for="branchname">VendorCompanyName</label>  
      								<div class="col-sm-8">  
	        							<input type="text" class="form-control" name="vendorCompanyName" placeholder="Enter VendorCompanyName" required pattern="[0-9a-zA-Z]{2,24}"
        						...
        						%>
  								<div class="form-group">          
      								<div class="col-sm-offset-6 col-sm-8">  
        								<button type="submit" class="btn btn-success" name="submitValue" value="createVendorCompany">
        									<strong>CreateVendorCompany</strong>
        								</button>  
      								</div>  
    							</div>
    						</form>
