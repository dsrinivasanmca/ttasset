				...
				<div class="row">
  					...
  					<div class="col-sm-8">
  						<div class="panel panel-primary well well-sm">
							<div class="panel-heading" align="center">Add New Department</div>
  							...
  							<form class="form-horizontal" method="post" action="DepartmentServlet">
								...
								String companyName = null;
  								...
  								<div class="form-group">  
      								...
      								<div class="col-sm-8">  
	        							<input type="text" class="form-control" name="departmentname" placeholder="Enter DepartmentName" required pattern="^(?=.*[A-Za-z0-9])[0-9a-zA-Z\s]{2,24}$"
        						...
        						%>
  								<div class="form-group">          
      								<div class="col-sm-offset-6 col-sm-8">  
        								<button type="submit" class="btn btn-success" name="submitValue" value="createDepartment">
        									<strong>CreateDepartment</strong>
        								</button>  
      								</div>  
    							</div>
    						</form>
